...
if __name__ == '__main__':
    try:
        ...
        start_Xbins, end_Xbins, start_Ybins, end_Ybins, num_blocks = m.blocks.split_map_into_blocks(full_startXbin, full_endXbin, full_startYbin, full_endYbin, block_Xsize, block_Ysize)  
